...
const ErrorPage = () => {
  return (
    <div className="relative h-screen">
      <img
        src="https://i.postimg.cc/XJS2ctDh/jelmer-assink-gze-Tj-Gu3b-k-unsplash.jpg"
      ...
      <div className="relative bg-gray-900 bg-opacity-75 h-full">
        <div className="flex flex-col justify-center items-center h-full max-w-2xl mx-auto">
          ...
          <Link to="/">
            <button className="bg-[#e08534] outline text-[white] px-4 py-3 rounded-lg hover:bg-[#c3732c] flex items-center">
